        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>${o.orderDate}</td>
                            <%
						com.LiLinqing.model.Order o=(com.LiLinqing.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.LiLinqing.dao.UserDao userDao=new com.LiLinqing.dao.UserDao();
                    ...
                    <td class="cart_total">
							...
							String paymentType=com.LiLinqing.model.Payment.findByPaymentId(con,n);
						%>
